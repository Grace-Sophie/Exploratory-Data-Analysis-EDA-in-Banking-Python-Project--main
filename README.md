...
In this project, I try to give answers to a set of questions that may be relevant when analyzing banking data:
...
In addition, we make a visual analysis in order to plan marketing banking campaigns more effectively.
